...
plot for [i=4:7] 'bf0.66_xn.dat' index 0 using 1:i with l lw 2 lt i title columnhead, '' index 1 using 1:3 pt 5 lt 5 title columnhead, for [i=3:4] '' index 2 using 1:i pt 5 lt (i+3) title columnhead
