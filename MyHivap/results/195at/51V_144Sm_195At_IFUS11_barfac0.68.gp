...
plot for [i=3:7] '51V_144Sm_195At_IFUS11_barfac0.68.dat' index 0 using 1:i with l lw 2.5 lt i title columnhead(i)
...
plot for [i=3:7] '51V_144Sm_195At_IFUS11_barfac0.68.dat' index 1 using 1:i with l lw 2.5 lt i title columnhead(i) 

set xlabel 'E* [MeV]' font ',12' offset 0,0
set xtics
set format x '%h'

plot for [i=3:7] '51V_144Sm_195At_IFUS11_barfac0.68.dat' index 2  using 1:i with l lw 2.5 lt i title columnhead
