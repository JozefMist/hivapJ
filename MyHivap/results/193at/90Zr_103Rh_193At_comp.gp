...
set title '90Zr+103Rh->193At*, BF=0.61, IFUS11, xth=0' font ',12' 
...
set xtics font ',10'
set xtics
plot for [i=3:6] '90Zr_103Rh_193At_comp.dat' index 0 using 1:i with l lw 2.5 lt i title columnhead(i), for [i=3:6] '' index 1 using 1:i with l lw 2.5 lt i dt 3 title ''
# 
# unset title
# set ylabel '{/Symbol s} [mb]' font ',12' offset -1,0
# set format x '' 
# plot for [i=3:6] '90Zr_103Rh_193At.dat' index 2 using 1:i with l lw 2.5 lt i title columnhead(i), for [i=3:6] '' index 3 using 1:i with l lw 2.5 lt i dt 3 title ''
# 
# unset title
